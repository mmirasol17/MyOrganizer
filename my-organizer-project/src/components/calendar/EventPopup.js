          ...
          <div className="bg-white px-4 pt-2 pb-4 sm:p-6 sm:pb-4">
            ...
            <div className="mb-4 flex flex-col">
              ...
              <input
                ...
                className={`
                  border border-gray-300 rounded-md w-full px-3 py-2 text-lg text-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-500 cursor-text 
                    ...
                    <div className="flex gap-2">
                      {["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"].map((day) => (
                        <button
                          key={day}
                          className={`
                            transition hover:scale-110 border border-gray-300 shadow-sm bg-gray-100 items-center justify-center rounded-full w-10 h-10 

...
export default function NotesHeader() {
  return (
    <div className="bg-yellow-200 h-12 items-center grid grid-cols-3 rounded-t-lg w-full text-center font-bold py-2 px-2">
      ...
      <div className="col-span-1 justify-self-end flex items-center">
        <Menu selectedOption={{ label: "New Note", value: "new" }} options={[{ label: "New Note", value: "new" }]} />
      </div>
    </div>
  );
}
